...
function Cards({
    ...
    return(
        <>l
        <div className="border rounded-lg p-4 max-w-sm shadow-g hover:shadow-2xl transition-shadow duration-300">
            ...
            <p className="text-sm text-gray-500 mb-2"><strong>Project Manager:</strong> {ProjectManager}</p>
            {teamMembers && (
